...
import com.norka.LoginPage.LoginPage2;
import com.norka.automationconstants.AutomationConstants;
public class TestClass2 extends TestBase {
	
	
		
		static LoginPage2 objlogin;
		
		
		@Test(priority=1)
		
		public static void verifyvalidlogin() throws IOException {
			String Inputname=Excelutility.getcelldata(1, 0);
			double EnterPassword=Excelutility.getcelldata1(1, 1);
